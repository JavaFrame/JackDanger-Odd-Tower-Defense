...
addMyGame("WrongTowerDefense", "My Game", "Spaßbringer08", "30 Sekunden ausweichen!", JackDanger.MyGame);
...
JackDanger.MyGame.prototype.preload = function() {
    ...
    this.load.atlas("WrongTowerDefense");
}
...
JackDanger.MyGame.prototype.addStuff = function(dt) {
    this.speed = 200;
    this.player = this.add.sprite(20,50, "WrongTowerDefense", "face");

    this.ball = this.add.sprite(600,Math.random() * 300, "WrongTowerDefense", "ball");
